# FluentUI Editable DetailsList (Forked)

## Overview

Version Breakdown:
8 Represents The Fluent Version For V8

X8.XX.XX-PROD (FOR USE IN PRODUCTION)
X8.XX.XX-DEV (Testing Functionality - Not For Consumption) 
X8.XX.XX-UST (HAS UNDERLYING ISSUES) 
...
## Demo Of Basic Features (Not Maintained - (More features added than what's in demo))
...
## Usage
    ...
    import { EditableGrid, EditControlType, IColumnConfig, EventEmitter, EventType, NumberAndDateOperators } from '@mercury/editable-detailslist-fluentui';
