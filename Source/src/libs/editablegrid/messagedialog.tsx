...
import { DefaultButton, Dialog, DialogFooter, mergeStyleSets } from '@fluentui/react';
...
const MessageDialog = (props: Props) => {
  const [messageDialogContent, setMessageDialogContent] = React.useState<JSX.Element | undefined>(
    undefined
  );
