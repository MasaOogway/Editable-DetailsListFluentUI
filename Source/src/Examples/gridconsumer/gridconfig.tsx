...
import { DepColTypes, DisableColTypes, IColumnConfig } from '../../libs/types/columnconfigtype';
...
export const GridColumnConfig: IColumnConfig[] = [
  ...
  // },
  {
    ...
    comboBoxProps: {
      ...
      nonStrictMaskingRequired: true,
      searchType: 'startswith'
    },
    comboBoxOptions: [
      { key: 'AAAA', text: 'Not Assigned' },
